...
pub fn registry() -> Vec<Box<dyn GridTest>> {
    vec![
        ...
        Box::new(crate::cases::experience_admin_contributor::ExperienceAdminContributor),
        ...
        Box::new(crate::cases::terrain_layerdata::TerrainLayerData),
        ...
        Box::new(crate::cases::avatar_appearance_npc::AvatarAppearanceNpc),
