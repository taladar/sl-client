...
pub use sl_proto::{
    ...
    ExtendedMesh, FlexibleData, Friend, FriendRights, GltfMaterialOverride, GridCoordinates,
    ...
    TextureKey, Throttle, ThrottleBuilder, ThrottleError, TransferId, TransferStatus, Transmit,
