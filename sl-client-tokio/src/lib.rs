...
pub use sl_proto::{
    ...
    FolderType, Friend, FriendRights, GestureActivation, GlobalCoordinates, Glow,
    ...
    RegionName, RegionTerrainComposition, Reliability, RenderMaterialEntry, RenderMaterialRef,
