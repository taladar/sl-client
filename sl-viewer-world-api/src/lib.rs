...
use sl_client_bevy::{
    ...
    MuteFlags, MuteList, MuteType, Object, ObjectExtraParams, ObjectKey, ObjectProperties,
    ...
    ScriptLanguage, ScriptTarget, ScriptUploadLocation, SculptOrMeshKey, SettingsKind,
