...
# The alias buttons (viewer-contact-set-pseudonyms): a name of the user's own
# for this resident, dropping it again, and hiding their chosen display name.
contact-sets-action-set-alias = Set Alias…
contact-sets-action-clear-alias = Rem Alias…
contact-sets-action-remove-display-name = Rem DN…
...
about-region-terrain-bake = Bake Terrain
...
build-tool-select-land = Land
build-land-select = Select Land
build-land-flatten = Flatten
build-land-raise = Raise
build-land-lower = Lower
build-land-smooth = Smooth
build-land-roughen = Roughen
build-land-revert = Revert
build-land-size-label = Size
build-land-strength-label = Strength
build-land-apply = Apply to selection
build-land-about = About Land
build-land-subdivide = Subdivide
build-land-join = Join
build-land-show-owners = Show owners
build-land-selection-none = No land selected
build-land-selection-area = Area: { $area } m²
...
preferences-row-autoresponse-item = Item sent with every autoresponse (item id)
preferences-section-auto-reject = Automatic rejection
preferences-row-reject-teleport-offers = Reject teleport offers and requests
preferences-row-dont-reject-teleport-from-friends = … but not from friends
preferences-row-reject-teleport-response = Rejected teleport reply
preferences-row-reject-friendship-requests = Reject friendship requests
preferences-row-reject-friendship-response = Rejected friendship reply
preferences-row-reject-group-invites = Reject group invitations
preferences-row-show-joined-group-invitations = Show invitations to groups I'm already in
preferences-row-ignore-ad-hoc-sessions = Ignore conference (ad-hoc) chat invitations
preferences-row-dont-ignore-ad-hoc-from-friends = … but not from friends
...
# ---------------------------------------------------------------------------
# The menus. Every `MenuCommand::label_key` / `PieAction::label_key` in the
# workspace resolves here: the two primary interaction surfaces are keys like
# everything else, so a translator reaches them without touching Rust.
#
# A surface's keys are grouped under its own heading and named after the
# English wording, so a line moving between menus is a visible diff rather
# than a silent re-use. Two surfaces that happen to share a word (Delete,
# Open, More) keep separate keys on purpose — the same English noun is often
# two different words once translated.
# ---------------------------------------------------------------------------

## The top menu bar (viewer-ui-menu-bar) — `src/menu_bar.rs`.
menu-bar-avatar = Avatar
menu-bar-preferences = Preferences…
menu-bar-inventory = Inventory
menu-bar-experiences = Experiences
menu-bar-quit = Quit
menu-bar-online-status = Online Status
menu-bar-away = Away
menu-bar-unavailable = Unavailable
menu-bar-autorespond = Autorespond
menu-bar-autorespond-to-non-friends = Autorespond to non-friends
menu-bar-reject-teleport-offers-and-requests = Reject teleport offers and requests
menu-bar-reject-all-group-invites = Reject all group invites
menu-bar-reject-all-friendship-requests = Reject all friendship requests
menu-bar-comm = Comm
menu-bar-conversations = Conversations
menu-bar-friends = Friends
menu-bar-groups = Groups
menu-bar-block-list = Block List
menu-bar-day-cycle = Day Cycle
menu-bar-sunrise = Sunrise
menu-bar-midday = Midday
menu-bar-sunset = Sunset
menu-bar-midnight = Midnight
menu-bar-legacy = Legacy
menu-bar-modern = Modern
menu-bar-bulk-import = Bulk Import
menu-bar-days = Days…
menu-bar-skies = Skies…
menu-bar-water = Water…
menu-bar-environment = Environment
menu-bar-use-shared-environment = Use Shared Environment
menu-bar-personal-lighting = Personal Lighting…
...
menu-bar-world-map = World Map
menu-bar-property-lines = Property Lines
menu-bar-land-owners = Land Owners
menu-bar-about-land = About Land…
menu-bar-place-profile = Place Profile…
menu-bar-region-estate = Region / Estate…
menu-bar-asset-blacklist = Asset Blacklist…
menu-bar-avatar-render-settings = Avatar Render Settings…
menu-bar-show-friends-only = Show Friends Only
menu-bar-build = Build
menu-bar-build-tools = Build Tools
menu-bar-undo = Undo
menu-bar-redo = Redo
menu-bar-link = Link
menu-bar-unlink = Unlink
menu-bar-content = Content
menu-bar-search = Search…
menu-bar-web-browser = Web Browser
menu-bar-help = Help
menu-bar-about = About…
menu-bar-shortcuts = Shortcuts
menu-bar-joystick-flycam = Joystick Flycam
menu-bar-advanced = Advanced
menu-bar-debug-settings = Debug settings…
menu-bar-collect-protocol-diagnostics = Collect Protocol Diagnostics
menu-bar-debug = Debug
menu-bar-show-debug-messages = Show Debug Messages
menu-bar-hide-unset-or-duplicate-messages = Hide Unset or Duplicate Messages
menu-bar-show-assertion-failures = Show Assertion Failures
menu-bar-hide-locked-layers = Hide Locked Layers
menu-bar-hide-locked-attachments = Hide Locked Attachments
menu-bar-hide-locked-inventory = Hide Locked Inventory
menu-bar-enable-legacy-naming = Enable Legacy Naming
menu-bar-enable-shared-wear = Enable Shared Wear
menu-bar-rename-shared-items-on-wear = Rename Shared Items on Wear
menu-bar-locks = Locks…
menu-bar-rlva = RLVa
menu-bar-enable-rlva = Enable RLVa
menu-bar-allow-ooc-chat = Allow OOC Chat
menu-bar-show-filtered-chat = Show Filtered Chat
menu-bar-show-redirected-chat-typing = Show Redirected Chat Typing
menu-bar-split-long-redirected-chat = Split Long Redirected Chat
menu-bar-allow-temporary-attachments = Allow Temporary Attachments
menu-bar-forbid-give-to-rlv = Forbid Give to #RLV
menu-bar-wear-replaces-unlocked = Wear Replaces Unlocked
menu-bar-console = Console…
menu-bar-restrictions = Restrictions…
menu-bar-strings = Strings…

## The inventory window's gear menu (viewer-inventory-*).
menu-inventory-gear = ⚙
menu-inventory-new-inventory-window = New Inventory Window
menu-inventory-gallery-view = Gallery View
menu-inventory-sort-by-name = Sort by Name
menu-inventory-sort-by-most-recent = Sort by Most Recent
menu-inventory-sort-folders-always-by-name = Sort Folders Always by Name
menu-inventory-sort-system-folders-to-top = Sort System Folders to Top
menu-inventory-show-filters = Show Filters...
menu-inventory-reset-filters = Reset Filters
menu-inventory-expand-all-folders = Expand All Folders
menu-inventory-collapse-all-folders = Collapse All Folders
menu-inventory-empty-lost-and-found = Empty Lost And Found
menu-inventory-save-texture-as = Save Texture As
menu-inventory-share = Share
menu-inventory-find-original = Find Original
menu-inventory-find-all-links = Find All Links
menu-inventory-replace-links = Replace Links
menu-inventory-show-links = Show Links
menu-inventory-show-only-links = Show Only Links
menu-inventory-hide-links = Hide Links
menu-inventory-empty-trash = Empty Trash

## The inventory's + / folder / item menus (viewer-inventory-actions).
menu-inv-new-clothes = New Clothes
...
menu-inv-new-alpha-mask = New Alpha Mask
menu-inv-new-tattoo = New Tattoo
menu-inv-new-universal = New Universal
menu-inv-new-physics = New Physics
menu-inv-new-body-parts = New Body Parts
menu-inv-new-shape = New Shape
menu-inv-new-skin = New Skin
menu-inv-new-hair = New Hair
menu-inv-new-eyes = New Eyes
menu-inv-upload = Upload
menu-inv-image = Image...
menu-inv-sound = Sound...
menu-inv-animation = Animation...
menu-inv-model = Model...
menu-inv-material = Material...
menu-inv-bulk = Bulk...
menu-inv-new-settings = New Settings
menu-inv-new-sky = New Sky
menu-inv-new-water = New Water
menu-inv-new-day-cycle = New Day Cycle
menu-inv-add-button = +
...
menu-inv-shop = Shop...
menu-inv-attach-to = Attach To
menu-inv-chest-1 = Chest (1)
menu-inv-skull-2 = Skull (2)
menu-inv-left-shoulder-3 = Left Shoulder (3)
menu-inv-right-shoulder-4 = Right Shoulder (4)
menu-inv-left-hand-5 = Left Hand (5)
menu-inv-right-hand-6 = Right Hand (6)
menu-inv-left-foot-7 = Left Foot (7)
menu-inv-right-foot-8 = Right Foot (8)
menu-inv-spine-9 = Spine (9)
menu-inv-pelvis-10 = Pelvis (10)
menu-inv-mouth-11 = Mouth (11)
menu-inv-chin-12 = Chin (12)
menu-inv-left-ear-13 = Left Ear (13)
menu-inv-right-ear-14 = Right Ear (14)
menu-inv-left-eyeball-15 = Left Eyeball (15)
menu-inv-right-eyeball-16 = Right Eyeball (16)
menu-inv-nose-17 = Nose (17)
menu-inv-r-upper-arm-18 = R Upper Arm (18)
menu-inv-r-forearm-19 = R Forearm (19)
menu-inv-l-upper-arm-20 = L Upper Arm (20)
menu-inv-l-forearm-21 = L Forearm (21)
menu-inv-right-hip-22 = Right Hip (22)
menu-inv-r-upper-leg-23 = R Upper Leg (23)
menu-inv-r-lower-leg-24 = R Lower Leg (24)
menu-inv-left-hip-25 = Left Hip (25)
menu-inv-l-upper-leg-26 = L Upper Leg (26)
menu-inv-l-lower-leg-27 = L Lower Leg (27)
menu-inv-stomach-28 = Stomach (28)
menu-inv-left-pec-29 = Left Pec (29)
menu-inv-right-pec-30 = Right Pec (30)
menu-inv-neck-39 = Neck (39)
menu-inv-avatar-center-40 = Avatar Center (40)
menu-inv-left-ring-finger-41 = Left Ring Finger (41)
menu-inv-right-ring-finger-42 = Right Ring Finger (42)
menu-inv-tail-base-43 = Tail Base (43)
menu-inv-tail-tip-44 = Tail Tip (44)
menu-inv-left-wing-45 = Left Wing (45)
menu-inv-right-wing-46 = Right Wing (46)
menu-inv-jaw-47 = Jaw (47)
menu-inv-alt-left-ear-48 = Alt Left Ear (48)
menu-inv-alt-right-ear-49 = Alt Right Ear (49)
menu-inv-alt-left-eye-50 = Alt Left Eye (50)
menu-inv-alt-right-eye-51 = Alt Right Eye (51)
menu-inv-tongue-52 = Tongue (52)
menu-inv-groin-53 = Groin (53)
menu-inv-left-hind-foot-54 = Left Hind Foot (54)
menu-inv-right-hind-foot-55 = Right Hind Foot (55)
menu-inv-attach-to-hud = Attach To HUD
menu-inv-center-2 = Center 2
menu-inv-top-right = Top Right
menu-inv-top = Top
menu-inv-top-left = Top Left
menu-inv-center = Center
menu-inv-bottom-left = Bottom Left
menu-inv-bottom = Bottom
menu-inv-bottom-right = Bottom Right
menu-inv-folder = Folder
menu-inv-share = Share
menu-inv-empty-trash = Empty Trash
menu-inv-empty-lost-and-found = Empty Lost And Found
menu-inv-replace-current-outfit = Replace Current Outfit
menu-inv-add-to-current-outfit = Add To Current Outfit
menu-inv-remove-from-current-outfit = Remove From Current Outfit
menu-inv-start-conference-chat = Start Conference Chat
menu-inv-rename = Rename
menu-inv-cut = Cut
menu-inv-copy = Copy
menu-inv-paste = Paste
menu-inv-paste-as-link = Paste As Link
menu-inv-delete = Delete
menu-inv-purge-item = Purge Item
menu-inv-restore-item = Restore Item
menu-inv-item = Item
menu-inv-open = Open
menu-inv-properties = Properties
menu-inv-show-in-main-view = Show in Main view
menu-inv-copy-asset-uuid = Copy Asset UUID
menu-inv-send-with-autoresponses = Send with Autoresponses
...
menu-inv-send-instant-message = Send Instant Message
menu-inv-offer-teleport = Offer Teleport...
menu-inv-activate = Activate
menu-inv-deactivate = Deactivate
...
## The mini-map's context menu (viewer-minimap-menu).
menu-minimap-mark = Mark
menu-minimap-mark-red = Mark Red
menu-minimap-mark-green = Mark Green
menu-minimap-mark-blue = Mark Blue
menu-minimap-mark-purple = Mark Purple
menu-minimap-mark-light-yellow = Mark Light Yellow
menu-minimap-clear-mark = Clear Mark
menu-minimap-clear-all-marks = Clear All Marks
menu-minimap-more-options = More Options
menu-minimap-im = IM
menu-minimap-add-friend = Add Friend
menu-minimap-add-to-set = Add to Set
menu-minimap-offer-teleport = Offer Teleport
menu-minimap-block = Block
menu-minimap-zoom = Zoom
menu-minimap-very-close = Very Close
menu-minimap-close = Close
menu-minimap-medium = Medium
menu-minimap-far = Far
menu-minimap-show = Show
menu-minimap-objects = Objects
menu-minimap-physical-objects = Physical Objects
menu-minimap-scripted-objects = Scripted Objects
menu-minimap-temp-on-rez-objects = Temp-on-rez Objects
menu-minimap-property-lines = Property Lines
menu-minimap-parcels-for-sale = Parcels for Sale
menu-minimap-chat-distance-rings = Chat Distance Rings
menu-minimap-show-rings = Show Rings
menu-minimap-whisper-range = Whisper Range
menu-minimap-chat-range = Chat Range
menu-minimap-shout-range = Shout Range
menu-minimap-minimap = Minimap
menu-minimap-view-profile = View Profile
menu-minimap-view-profiles = View Profiles
menu-minimap-start-tracking = Start Tracking
menu-minimap-stop-tracking = Stop Tracking
menu-minimap-north-at-top = North at Top
menu-minimap-camera-at-top = Camera at Top
menu-minimap-auto-center-map = Auto-center Map
menu-minimap-re-center-map = Re-center Map

## The world map's context menu (viewer-world-map-menu).
menu-world-map-show = Show
menu-world-map-people = People
menu-world-map-telehubs = Telehubs
menu-world-map-land-for-sale = Land for Sale
menu-world-map-events = Events
menu-world-map-moderate-events = Moderate Events
menu-world-map-adult-events = Adult Events
menu-world-map-region-names = Region Names
menu-world-map-zoom = Zoom
menu-world-map-close = Close
menu-world-map-medium = Medium
menu-world-map-far = Far
menu-world-map-whole-grid = Whole Grid
menu-world-map-world-map = World Map
menu-world-map-center-on-me = Center on Me

## The avatar radar's row menu (viewer-radar-menu).
menu-radar-mark = Mark
menu-radar-mark-red = Mark Red
menu-radar-mark-green = Mark Green
menu-radar-mark-blue = Mark Blue
menu-radar-mark-purple = Mark Purple
menu-radar-mark-light-yellow = Mark Light Yellow
menu-radar-clear-mark = Clear Mark
menu-radar-clear-all-marks = Clear All Marks
menu-radar-render-settings = Render Settings
menu-radar-render-normally = Render Normally
menu-radar-do-not-render = Do Not Render
menu-radar-render-fully = Render Fully
menu-radar-radar = Radar
menu-radar-view-profile = View Profile
menu-radar-im = IM
menu-radar-start-tracking = Start Tracking
menu-radar-stop-tracking = Stop Tracking
menu-radar-teleport-to = Teleport To
menu-radar-offer-teleport = Offer Teleport
menu-radar-add-friend = Add Friend
menu-radar-remove-friend = Remove Friend
menu-radar-add-to-set = Add to Set
menu-radar-block = Block
menu-radar-unblock = Unblock
menu-radar-derender = Derender
menu-radar-derender-blacklist = Derender + Blacklist
menu-radar-view-profiles = View Profiles
menu-radar-add-friends = Add Friends
menu-radar-remove-friends = Remove Friends

## The block list's row menu (viewer-people-blocked).
menu-blocked-blocked = Blocked
menu-blocked-unblock = Unblock
menu-blocked-block-text = Block Text
menu-blocked-block-voice = Block Voice
menu-blocked-block-particles = Block Particles
menu-blocked-block-object-sounds = Block Object Sounds
menu-blocked-profile = Profile...

## My Environments' row menu (viewer-my-environments).
menu-my-env-environment = Environment
menu-my-env-edit = Edit
menu-my-env-apply-only-to-myself = Apply Only To Myself
menu-my-env-copy-uuid = Copy UUID
menu-my-env-delete = Delete

## The avatar pie menus (viewer-avatar-context-menu).
pie-avatar-mute = Mute
pie-avatar-mute-particle-owner = Mute Particle Owner
pie-avatar-add = Add
pie-avatar-add-as-friend = Add as Friend
pie-avatar-add-to-set = Add to Set
pie-avatar-set-alias = Set Alias
pie-avatar-more = More
pie-avatar-textures = Textures
pie-avatar-script-info = Script Info
pie-avatar-call = Call
pie-avatar-zoom-in = Zoom In
pie-avatar-tex-refresh = Tex Refresh
pie-avatar-freeze = Freeze
pie-avatar-give-card = Give Card
pie-avatar-invite-to-group = Invite to Group
pie-avatar-face-towards = Face Towards
pie-avatar-eject = Eject
pie-avatar-render = Render
pie-avatar-fully = Fully
pie-avatar-normally = Normally
pie-avatar-never = Never
pie-avatar-derender = Derender
pie-avatar-blacklist = Blacklist
pie-avatar-temporary = Temporary
pie-avatar-avatar = Avatar
pie-avatar-profile = Profile
pie-avatar-go-to = Go To
pie-avatar-report = Report
pie-avatar-pay = Pay
pie-avatar-im = IM
pie-avatar-clothes = Clothes
pie-avatar-shirt = Shirt
pie-avatar-pants = Pants
pie-avatar-shoes = Shoes
pie-avatar-socks = Socks
pie-avatar-jacket = Jacket
pie-avatar-gloves = Gloves
pie-avatar-skirt = Skirt
pie-avatar-take-off = Take Off
pie-avatar-detach-hud = Detach HUD
pie-avatar-detach = Detach
pie-avatar-detach-all = Detach All
pie-avatar-reset = Reset
pie-avatar-skeleton-and-animations = Skeleton & Animations
pie-avatar-skeleton = Skeleton
pie-avatar-mesh-lod = Mesh LOD
pie-avatar-appearance = Appearance
pie-avatar-edit-shape = Edit Shape
pie-avatar-texture-refresh = Texture Refresh
pie-avatar-edit-outfit = Edit Outfit
pie-avatar-dump-xml = Dump XML
pie-avatar-hover-height = Hover Height
pie-avatar-self = Self
pie-avatar-groups = Groups
pie-avatar-sit-down = Sit Down
pie-avatar-stand-up = Stand Up
pie-avatar-gestures = Gestures

## The attachment pie menus (viewer-attachment-context-menu).
pie-attachment-derender = Derender
pie-attachment-temporary = Temporary
pie-attachment-blacklist = Blacklist
pie-attachment-save-as = Save As
pie-attachment-backup = Backup
pie-attachment-collada = Collada
pie-attachment-more = More
pie-attachment-tex-refresh = Tex Refresh
pie-attachment-script-info = Script Info
pie-attachment-touch = Touch
pie-attachment-show-in-inv = Show in Inv.
pie-attachment-inspect = Inspect
pie-attachment-textures = Textures
pie-attachment-appearance = Appearance
pie-attachment-edit-shape = Edit Shape
pie-attachment-edit-outfit = Edit Outfit
pie-attachment-dump-xml = Dump XML
pie-attachment-hover-height = Hover Height
pie-attachment-attachment = Attachment
pie-attachment-profile = Profile
pie-attachment-drop = Drop
pie-attachment-sit-here = Sit Here
pie-attachment-stand-up = Stand Up
pie-attachment-detach = Detach
pie-attachment-gestures = Gestures
pie-attachment-edit = Edit
pie-attachment-add = Add
pie-attachment-add-as-friend = Add as Friend
pie-attachment-add-to-set = Add to Set
pie-attachment-display = Display
pie-attachment-normally = Normally
pie-attachment-never = Never
pie-attachment-fully = Fully
pie-attachment-call = Call
pie-attachment-zoom-in = Zoom In
pie-attachment-freeze = Freeze
pie-attachment-give-card = Give Card
pie-attachment-invite-to-group = Invite to Group
pie-attachment-face-towards = Face Towards
pie-attachment-eject = Eject
pie-attachment-avatar = Avatar
pie-attachment-go-to = Go To
pie-attachment-report = Report
pie-attachment-pay = Pay
pie-attachment-im = IM

## The object pie menus (viewer-object-context-menu).
pie-object-take = Take
pie-object-copies-separately = Copies: Separately
pie-object-take-copy = Take Copy
pie-object-take-combined = Take: Combined
pie-object-copy-combined = Copy: Combined
pie-object-take-separately = Take: Separately
pie-object-attach-hud = Attach HUD
pie-object-more = More
pie-object-alt-r-ear = Alt R Ear
pie-object-alt-r-eye = Alt R Eye
pie-object-tongue = Tongue
pie-object-alt-l-eye = Alt L Eye
pie-object-alt-l-ear = Alt L Ear
pie-object-l-ring-finger = L Ring Finger
pie-object-jaw = Jaw
pie-object-r-ring-finger = R Ring Finger
pie-object-ext-skeleton = Ext. Skeleton
pie-object-right-wing = Right Wing
pie-object-groin = Groin
pie-object-tail-base = Tail Base
pie-object-tail-tip = Tail Tip
pie-object-left-wing = Left Wing
pie-object-l-hind-foot = L Hind Foot
pie-object-r-hind-foot = R Hind Foot
pie-object-attach = Attach
pie-object-reset = Reset
pie-object-tex-refresh = Tex Refresh
pie-object-skeleton = Skeleton
pie-object-derender = Derender
pie-object-blacklist = Blacklist
pie-object-temporary = Temporary
pie-object-save-as = Save As
pie-object-backup = Backup
pie-object-collada = Collada
pie-object-dump-xml = Dump XML
pie-object-pathfinding = Pathfinding
pie-object-show-in-linksets = Show in Linksets
pie-object-show-in-characters = Show in Characters
pie-object-mute = Mute
pie-object-part-owner = Part. Owner
pie-object-scripts = Scripts
pie-object-compile-mono = Compile (Mono)
pie-object-compile-lsl = Compile (LSL)
pie-object-reset-scripts = Reset Scripts
pie-object-run-scripts = Run Scripts
pie-object-stop-scripts = Stop Scripts
pie-object-remove-scripts = Remove Scripts
pie-object-script-info = Script Info
pie-object-report = Report
pie-object-inspect = Inspect
pie-object-delete = Delete
pie-object-wear = Wear
pie-object-return = Return
pie-object-buy = Buy
pie-object-object = Object
pie-object-open = Open
pie-object-create = Create
pie-object-touch = Touch
pie-object-sit-here = Sit Here
pie-object-stand-up = Stand Up
pie-object-pay = Pay
pie-object-edit = Edit

## The land pie menu (viewer-land-context-menu).
pie-land-land = Land
pie-land-about-land = About Land...
pie-land-create = Create
pie-land-go-here = Go Here
pie-land-sit-here = Sit Here
pie-land-mute-part-own = Mute Part. Own.
pie-land-buy-pass = Buy Pass
pie-land-edit-terrain = Edit Terrain
pie-land-buy-this-land = Buy This Land

## The line-menu widget's gallery fixture (`menu::FIXTURE_MENU_BAR`).
menu-fixture-environment = Environment
menu-fixture-sunrise = Sunrise
menu-fixture-midday = Midday
menu-fixture-sunset = Sunset
menu-fixture-avatar = Avatar
menu-fixture-inventory = Inventory
menu-fixture-appearance = Appearance
menu-fixture-fly = Fly
menu-fixture-sit-down = Sit Down
menu-fixture-quit = Quit
menu-fixture-world = World
menu-fixture-mini-map = Mini-Map
menu-fixture-teleport-home = Teleport Home
menu-fixture-region-debug-console = Region Debug Console

## The pie widget's gallery fixture (`pie_menu::FIXTURE_PIE`).
pie-fixture-about-land = About Land
pie-fixture-buy-land = Buy Land
pie-fixture-land = Land
pie-fixture-manage = Manage
pie-fixture-take-copy = Take Copy
pie-fixture-object = Object
pie-fixture-touch = Touch
pie-fixture-stand-up = Stand Up
pie-fixture-sit-here = Sit Here
pie-fixture-edit = Edit
pie-fixture-open = Open

# ---------------------------------------------------------------------------
# Settings descriptions. Every `ViewerSettings::register_in` names one of these
# keys instead of an English sentence; `i18n::apply_setting_descriptions`
# resolves it into the settings store, from where the raw settings editor draws
# it and the TOML writer places it above the value in the user's own file. So a
# translated viewer writes a settings file a reader of that language can read.
#
# The key is the setting's own name (`setting-desc-<Name>`) wherever a setting
# has one; a family whose names are built at runtime — one per floater, per
# audio bus, per notification — shares a single key, since one sentence
# describes every member.
# ---------------------------------------------------------------------------

setting-desc-AfkTimeoutSeconds = Seconds of inactivity before going away automatically (0 = never)
setting-desc-AllowTapTapHoldRun = Double-tap and hold a walk key to run
setting-desc-ApplyColorImmediately = Hand a colour to whatever is being tinted while it is being picked
setting-desc-AssetCacheSizeMb = Size ceiling in MB for each asset disk cache (takes effect on restart)
setting-desc-AudioOutputDevice = The audio output device, by name (empty: the system default)
setting-desc-AutoAcceptNewInventory = Silently accept inventory offers into the type-appropriate folder
setting-desc-AutoLeveling = Ease the flycam horizon back to level
setting-desc-AutomaticFly = Take off by holding the jump key (landing by holding crouch stays on)
setting-desc-AutorespondMode = Answer incoming IMs with the autorespond reply
setting-desc-AutorespondNonFriendsMode = Answer incoming IMs from non-friends with the autorespond reply
setting-desc-AutorespondNonFriendsResponse = The automatic reply sent to non-friends' IMs while in autorespond-to-non-friends mode
setting-desc-AutorespondResponse = The automatic reply sent to IMs while in autorespond mode
setting-desc-AutoresponseItemUUID = The inventory item sent with every autoresponse (item id; empty = none)
setting-desc-AvatarFeathering = Avatar-motion feathering (less is softer)
setting-desc-AvatarSitOnAway = Sit the avatar down while away, standing back up on return
setting-desc-AvatarTurnRate = How fast the left / right keys turn the avatar, radians per second
setting-desc-AwayAvatarResponse = The automatic reply sent to IMs while away
setting-desc-BubbleOpacity = Opacity of the name-tag backdrop bubble
setting-desc-BusyResponse = The automatic reply sent to IMs while in Do Not Disturb mode
setting-desc-CacheLocation = Custom cache directory; empty = the platform default (takes effect on restart)
setting-desc-CameraAngle = World camera vertical field of view in radians
setting-desc-CameraMaxDistance = Farthest the third-person camera zooms from the avatar, in metres
setting-desc-CameraOffsetScale = Multiplier on the third-person camera's distance from the avatar
setting-desc-CameraSmoothingHalfLife = Camera smoothing half-life in seconds; 0 disables the smoothing
setting-desc-ChatColorIm = Colour of instant-message and group-chat lines (skin --chat-im)
setting-desc-ChatColorObjects = Chat colour of object chat (skin --chat-objects)
setting-desc-ChatColorOthers = Chat colour of other avatars' lines (skin --chat-others)
setting-desc-ChatColorSelf = Chat colour of my own lines (RGB override of the skin's --chat-self)
setting-desc-ChatColorSystem = Colour of system and viewer-notice chat lines (skin --chat-system)
setting-desc-ChatFontSize = Chat text size: 0 = small, 1 = medium, 2 = large
setting-desc-ChatLogLocation = Custom chat-log directory; empty = the platform default (takes effect on restart)
setting-desc-ChatOnlineNotification = Show a toast when a friend comes online or goes offline
setting-desc-ChatOverlayMaxLines = The most nearby-chat overlay lines shown at once
setting-desc-CollectProtocolDiagnostics = Collect protocol diagnostics (decode failures, unhandled messages, unknown capability events, missing replies) and report them to the log. Costs a little per inbound message; turn it off to run the session lean
setting-desc-ColorByDistance = Tint whole name tags by chat range (whisper/say/shout)
setting-desc-ContactSetsNotificationToast = Show that toast for contact sets marked to notify, even when the above is off
setting-desc-ConversationLogRetentionDays = Days an inactive conversation stays in conversation.log
setting-desc-DebugSettingsHideDefault = Show only settings with an override in the debug-settings editor
setting-desc-DemoBindingFlag = Demo bound flag
setting-desc-DemoBindingLevel = Demo bound level
setting-desc-DontIgnoreAdHocFromFriends = Exempt friends from the ad-hoc conference rejection
setting-desc-DontRejectTeleportOffersFromFriends = Exempt friends from the teleport-offer rejection
setting-desc-DoubleClickAction = In-world double-click action: 0 nothing, 1 teleport, 2 walk (autopilot)
setting-desc-EnableCollisionSounds = Play the viewer-synthesized material sound when physical objects collide
setting-desc-EnvironmentManualTransitionTime = Seconds to blend between sky/water settings when the environment is changed by hand. 0 is immediate.
setting-desc-EnvironmentPersistAcrossLogin = Restore the personal (local) environment at the next login.
...
setting-desc-FadeStartDistance = Distance in metres at which name tags start to fade
setting-desc-FirstPersonAvatarVisible = Show my own avatar (and its attachments) while in mouselook
setting-desc-FlycamFeathering = Flycam feathering (less is softer)
setting-desc-FramePerSecondLimit = The frame-rate cap, frames per second, while FSLimitFramerate is on
setting-desc-HoverTextFadeDistance = Distance in metres at which floating object text starts to fade
setting-desc-HoverTextFadeRange = Metres past the fade start at which floating object text is hidden
setting-desc-HttpProxy = The HTTP proxy as host:port, e.g. 127.0.0.1:8888 (takes effect on restart)
setting-desc-HttpProxyEnabled = Route all HTTP traffic through the HTTP proxy (takes effect on restart)
setting-desc-IgnoreAdHocSessions = Silently decline every ad-hoc conference invitation
setting-desc-ImViaEmail = Server state: email me IMs that arrive while I'm offline (OpenSim)
setting-desc-InvertMouse = Invert the vertical mouse look (mouse up looks down)
setting-desc-JoystickRunThreshold = Forward-push magnitude past which walking becomes running
setting-desc-KeepConversationLog = Keep the conversation.log index of past conversations
setting-desc-KeywordAlertColor = Chat keyword-alert highlight colour (skin --keyword-alert)
setting-desc-LandBrushForce = The terraform bulldozer's strength multiplier
setting-desc-LandBrushSize = The terraform bulldozer's radius, in metres (1..=11)
setting-desc-LogFileNameWithDate = Add a date suffix to transcript filenames
setting-desc-LogInstantMessages = Save IMs, group chat and conference chat to per-conversation transcripts
setting-desc-LogNearbyChat = Save nearby chat to the per-avatar transcript directory
setting-desc-LogTimestamp = Prefix each logged line with a timestamp
setting-desc-LogTimestampDate = Include the date in logged timestamps
setting-desc-LogTimestampSeconds = Include seconds in logged timestamps
setting-desc-LoginStartLocation = The default login start location: last, home, or uri:Region&x&y&z
setting-desc-MediaAutoPlayEnabled = Start media-on-a-prim faces marked auto-play without a click
setting-desc-MediaSoundsEarLocation = Where the ears are: 0 the camera position, 1 the avatar position
setting-desc-MiniMapAutoCenter = Ease a panned minimap back to centre
setting-desc-MiniMapChatRing = Show chat-distance rings on the minimap
setting-desc-MiniMapForSaleParcels = Fill for-sale and auction parcels on the minimap
setting-desc-MiniMapObjects = Show objects on the minimap
setting-desc-MiniMapOpacity = Minimap surface opacity
setting-desc-MiniMapPrimMaxRadius = Largest radius (metres) an object draws with on the minimap
setting-desc-MiniMapPrimMaxVertDistance = Hide minimap objects more than this many metres above/below the agent (0 = no limit)
setting-desc-MiniMapRotate = Rotate the minimap so the camera heading points up (off = north up)
setting-desc-MiniMapSayRing = Show the say-range ring (when chat rings are on)
setting-desc-MiniMapScale = Minimap zoom, in pixels per 256 m region (32-4096)
setting-desc-MiniMapShoutRing = Show the shout-range ring (when chat rings are on)
setting-desc-MiniMapShowPropertyLines = Show parcel property lines on the minimap
setting-desc-MiniMapWhisperRing = Show the whisper-range ring (when chat rings are on)
setting-desc-MinimapColorAvatar = Minimap dot colour of other avatars (skin --minimap-avatar)
setting-desc-MinimapColorAvatarFriend = Minimap dot colour of friends (skin --minimap-avatar-friend)
setting-desc-MinimapColorAvatarLinden = Minimap dot colour of grid staff (skin --minimap-avatar-linden)
setting-desc-MinimapColorAvatarMuted = Minimap dot colour of blocked residents (skin --minimap-avatar-muted)
setting-desc-MinimapColorAvatarSelf = Minimap marker colour of my own avatar (skin --minimap-avatar-self)
setting-desc-MinimapColorTrack = Minimap and world-map tracking-beacon colour (skin --minimap-track)
setting-desc-MinimapPickScale = Minimap hover pick radius, as a multiple of the dot radius
setting-desc-MouseSensitivity = Mouselook mouse sensitivity (the reference viewer's 0-15 scale)
setting-desc-MusicStreamEnabled = Play the parcel's music stream automatically (off by default; the play button on the audio bar starts a stream on demand)
setting-desc-MuteWhenMinimized = Mute audio while the viewer window is minimised / unfocused
setting-desc-MutedAvatarResponse = The automatic reply sent to a blocked resident's IM
setting-desc-NameTagColorDefault = Base name-tag colour (skin --name-tag-default)
setting-desc-NameTagColorFriend = Friends' name-tag colour, the friend highlight (skin --name-tag-friend)
setting-desc-NameTagColorLinden = Grid staff (Linden) name-tag colour (skin --name-tag-linden)
setting-desc-NameTagColorMismatch = Custom-display-name name-tag colour (skin --name-tag-mismatch)
setting-desc-NameTagColorMuted = Muted avatars' name-tag colour (skin --name-tag-muted)
setting-desc-NameTagColorSelf = My own name-tag colour (skin --name-tag-self)
setting-desc-NameTagDistanceColorBeyond = Distance-band tag colour beyond shout range (skin --name-tag-distance-beyond)
setting-desc-NameTagDistanceColorChat = Distance-band tag colour inside chat range (skin --name-tag-distance-chat)
setting-desc-NameTagDistanceColorShout = Distance-band tag colour inside shout range (skin --name-tag-distance-shout)
setting-desc-NameTagDistanceColorWhisper = Distance-band tag colour inside whisper range (skin --name-tag-distance-whisper)
setting-desc-NearbyChatToastLifetime = Seconds a nearby-chat overlay line stays on screen (including the fade)
setting-desc-NetMapDoubleClickAction = Minimap double-click action: 0 nothing, 1 world map, 2 teleport
setting-desc-NetMapPhantomOpacity = Phantom-object opacity on the minimap, in percent
setting-desc-NetMapPhysical = Highlight physical objects on the minimap
setting-desc-NetMapScripted = Highlight scripted objects on the minimap
setting-desc-NetMapTempOnRez = Highlight temp-on-rez objects on the minimap
setting-desc-NotifyAllExperienceEvents = Raise a toast for every experience event, not just record it in the log
setting-desc-OnlineStatusHidden = Server state: hide my online status from the people directory
setting-desc-PreferredMaturity = The maturity rating ceiling to ask the grid for: PG, M or A
setting-desc-PrimTextMaxDrawDistance = Hard maximum distance in metres at which floating object text is drawn
setting-desc-QuitAfterSecondsOfAFK = Seconds of being away before the viewer logs out (0 = never)
setting-desc-RLVaDebugHideUnsetDuplicate = Hide the console echo of a command that changed nothing
setting-desc-RLVaEnableIMQuery = Answer @list and @except asked over instant message
setting-desc-RLVaEnableLegacyNaming = Use the legacy naming rules when anonymising a resident
setting-desc-RLVaEnableSharedWear = Allow wearing items from the shared #RLV folder by hand
setting-desc-RLVaEnableTemporaryAttachments = Allow scripts to attach temporary attachments
setting-desc-RLVaHideLockedAttachments = Hide a locked attachment instead of greying it out
setting-desc-RLVaHideLockedInventory = Hide a locked item from the inventory listing
setting-desc-RLVaHideLockedLayers = Hide a locked clothing layer instead of greying it out
setting-desc-RLVaLoginLastLocation = Allow logging in to the last location while RLV is on
setting-desc-RLVaSharedInvAutoRename = Rename an item dropped into #RLV to carry its attachment point
setting-desc-RLVaShowAssertionFailures = Surface an internal RLVa assertion failure, not only log it
setting-desc-RLVaShowRedirectChatTyping = Keep sending the typing indicator while chat is redirected
setting-desc-RLVaSplitRedirectChat = Split a long redirected line instead of truncating it
setting-desc-RLVaWearReplaceUnlocked = Wearing over a locked layer replaces the unlocked items on it
setting-desc-RadarAgeAlert = Alert on avatars below the age threshold
setting-desc-RadarAgeAlertDays = The radar age alert's threshold, in days
setting-desc-RadarAlertOutput = Where radar alerts go: 'chat' (Nearby Chat line) or 'toast'
setting-desc-RadarLimitByRange = Limit the radar list to the near-me range
setting-desc-RadarNearMeRange = The radar near-me range limit, in metres
setting-desc-RadarReportChatRangeEnter = Report avatars entering chat range
setting-desc-RadarReportChatRangeLeave = Report avatars leaving chat range
setting-desc-RadarReportDrawRangeEnter = Report avatars entering draw distance
setting-desc-RadarReportDrawRangeLeave = Report avatars leaving draw distance
setting-desc-RadarReportSimRangeEnter = Report avatars entering the region
setting-desc-RadarReportSimRangeLeave = Report avatars leaving the region
setting-desc-RadioLandBrushAction = The land tool's picked action: 0 = select land, 1..=6 = the flatten / raise / lower / smooth / roughen / revert brushes
setting-desc-RejectAllGroupInvitesMode = Reject every incoming group invitation
setting-desc-RejectFriendshipRequestsMode = Reject every incoming friendship request
setting-desc-RejectFriendshipRequestsResponse = The automatic reply sent to a rejected friendship request
setting-desc-RejectTeleportOffersMode = Reject every incoming teleport offer and request
setting-desc-RejectTeleportOffersResponse = The automatic reply sent to a rejected teleport offer
setting-desc-RenderAutoMuteSurfaceAreaLimit = Draw an avatar whose attachments cover more than this many square metres as a flat silhouette (0 = no area limit)
setting-desc-RenderAvatarComplexityMode = How the avatar complexity limit treats friends: 0 by complexity alone, 1 always draw friends fully, 2 draw only friends fully
setting-desc-RenderAvatarMaxComplexity = Draw an avatar costing more than this as a flat silhouette (0 = no limit)
setting-desc-RenderDynamicExposureCoefficient = Average luminance at which the dynamic exposure reaches its floor
setting-desc-RenderDynamicExposureEnabled = Drive the tone-map exposure from the scene's average luminance
setting-desc-RenderDynamicExposureSpeedError = Fraction of the exposure error still remaining after the target time
setting-desc-RenderDynamicExposureSpeedTarget = Seconds over which the exposure eases toward a new target
setting-desc-RenderExposure = Linear scene-colour scale before the tone curve
setting-desc-RenderFarClip = Draw distance in metres: how far the simulator streams objects and terrain toward the agent (a larger value opens child circuits to neighbouring regions)
setting-desc-RenderFriendsOnly = Draw only friends' avatars (a crowded-event performance filter)
setting-desc-RenderFriendsOnlyPersistsTP = Keep the friends-only filter on across a teleport
setting-desc-RenderGlow = Render the Second Life glow / bloom pass
setting-desc-RenderGlowIterations = Number of separable-Gaussian blur iterations (each is two passes)
setting-desc-RenderGlowStrength = Additive strength of the glow, applied each blur pass
...
setting-desc-RenderSkyAutoAdjustLegacy = Let a legacy sky adapt as if it carried the auto-adjust probe ambiance
setting-desc-RenderTonemapMix = How far the tone curve is blended over the merely-exposed colour (0-1)
setting-desc-RenderTonemapType = Tone curve: 0 Khronos PBR Neutral, 1 ACES (default), 2 none
setting-desc-RenderUseExposureSkySettings = Source the exposure range from the sky's HDR offset/min/max settings
setting-desc-RenderVSyncEnable = Sync presentation to the monitor refresh (vsync)
setting-desc-RenderVolumeLODFactor = Object mesh / prim detail multiplier (RenderVolumeLODFactor): a larger value keeps finer geometry to a greater distance
setting-desc-RestrainedLove = Obey RLV / RLVa commands from worn objects
setting-desc-RestrainedLoveCanOOC = Let ((out of character)) chat through a chat restriction
setting-desc-RestrainedLoveDebug = Echo every processed RLV command into the RLVa console
setting-desc-RestrainedLoveForbidGiveToRLV = Refuse inventory offers into the shared #RLV folder
setting-desc-RestrainedLoveNoSetEnv = Refuse script control of the environment (@setenv)
setting-desc-RestrainedLoveReplaceWhenFolderBeginsWith = Shared-folder name prefix meaning "wear instead of"
setting-desc-RestrainedLoveShowEllipsis = Say a blanked line as "..." rather than saying nothing
setting-desc-RestrainedLoveStackWhenFolderBeginsWith = Shared-folder name prefix meaning "wear in addition to"
setting-desc-SavedPersonalEnvironment = The personal environment saved for this account, as JSON. Written by the viewer.
setting-desc-SearchLandAscending = Sort Land search results ascending
setting-desc-SearchPeopleOnlineOnly = Restrict People search to online avatars
setting-desc-SendAwayAvatarResponse = Answer incoming IMs while away with the away reply
setting-desc-SendMutedAvatarResponse = Tell a blocked resident their IM was not delivered
setting-desc-ShowAutorespondInNameTag = Show an Auto-Response status on your own tag while an autorespond mode is on
setting-desc-ShowComplexity = Show the render-cost (complexity) line on name tags
setting-desc-ShowComplexityWhenLimitedOnly = Show other avatars' render cost only while the complexity limit is limiting them
setting-desc-ShowDisplayNames = Show display names on name tags (off: legacy names only)
setting-desc-ShowDistance = Show the camera distance line on name tags
setting-desc-ShowFriendColor = Colour friends' name tags
setting-desc-ShowGroupNoticeToasts = Show a toast when a group notice arrives
setting-desc-ShowGroupTitles = Show the active group title line on name tags
setting-desc-ShowHoverText = Show floating text (llSetText) over in-world objects
setting-desc-ShowHoverTips = Show hover tooltips over objects and avatars
setting-desc-ShowJoinedGroupInvitations = Show invitations to groups I am already a member of
setting-desc-ShowLandTips = Show a hover tooltip over land when nothing else is under the cursor
setting-desc-ShowNameTags = Show floating name tags over avatars
setting-desc-ShowOwnComplexity = Show the render-cost line on your own name tag (your only read-out of it)
setting-desc-ShowOwnNameTag = Show the name tag over your own avatar too
setting-desc-ShowParcelOwners = Tint the ground itself by parcel-ownership class (green = yours, aqua = your group's, red = someone else's, orange = for sale, violet = auction, grey = public)
setting-desc-ShowPropertyLines = Show the in-world parcel property lines (colour-coded by ownership)
setting-desc-ShowTyping = Show a Typing status line while an avatar is typing
setting-desc-ShowUsernames = Show the username line under a custom display name
setting-desc-TempDerenderUntilTeleport = Temporary derenders last until the next teleport (otherwise: the whole session)
setting-desc-TextureCacheSizeMb = Texture disk cache size ceiling in MB (takes effect on restart)
setting-desc-ThrottleBandwidthKbps = Maximum UDP bandwidth requested from the simulator, kilobits per second
setting-desc-UiLanguage = The interface language (en, ja, ar, pl, pseudo); empty = system/default
setting-desc-UiScale = The UI scale factor (1.0 = native size)
setting-desc-UiSkin = The UI skin (a directory under assets/skins)
setting-desc-UiSkinTheme = The skin's theme overlay; empty for the skin's own base
setting-desc-UseLegacyIMLogNames = Name transcript files with the legacy resident-name scheme
setting-desc-WorldMapScale = World-map zoom, in pixels per 256 m region (1-256)
setting-desc-WorldMapShowAdultEvents = Show Adult event markers on the world map
setting-desc-WorldMapShowEvents = Show event markers on the world map
setting-desc-WorldMapShowInfohubs = Show telehub / infohub markers on the world map
setting-desc-WorldMapShowLandForSale = Show land-for-sale markers on the world map
setting-desc-WorldMapShowMatureEvents = Show Moderate event markers on the world map
setting-desc-WorldMapShowPeople = Show avatar markers on the world map
setting-desc-WorldMapShowRegionNames = Show region names on the world map (region-detail zoom)
setting-desc-audio-bus-mute = Whether this audio bus is muted (mute retains the volume level)
setting-desc-audio-bus-volume = Linear volume (0-1) for this audio bus
setting-desc-blocked_recvim = Shown in place of the original message when an incoming IM is blocked
setting-desc-blocked_recvim_remote = Sent to the remote party when their IM was blocked
setting-desc-blocked_sendim = Shown (and sent to the remote party) when an outgoing IM is blocked
setting-desc-blocked_tplurerequest_remote = Sent to the remote party when their teleport offer or request was blocked
setting-desc-color-picker-palette-swatch = A saved colour-picker palette swatch
setting-desc-floater-docked = Whether the window is docked into its host
setting-desc-floater-minimized = Whether the window is collapsed to its title bar
setting-desc-floater-rect = Window rectangle (logical px [left, top, right, bottom]); a zero-width rect is a content-sized window
setting-desc-floater-tab-split = Tab widget's strip / content split width (logical px)
setting-desc-floater-visible = Whether the window is open
setting-desc-friends_sort = Friends-list sort order, most-significant column first (col:dir, …).
setting-desc-imquery_list_deny = Sent to the remote party when you deny their request to list your active RLV restrictions
setting-desc-imquery_list_suffix = Sent to the remote party as a suffix to @list to inform them how to request your exceptions
...
setting-desc-render_reflection_probe_dynamic_content = Capture dynamic content (avatars) in local reflection probes. Costlier, and it defeats probe change-detection (an animating avatar dirties its probe every frame); the environment-only default probe is unaffected either way.
setting-desc-search-include-adult = Include Adult results in this search category
setting-desc-search-include-general = Include General (PG) results in this search category
setting-desc-search-include-moderate = Include Moderate (Mature) results in this search category
setting-desc-snapshot_format = last-used snapshot output format (index into the floater's list)
setting-desc-snapshot_hide_balance = blank the status-bar L$ balance in snapshots that include the UI
setting-desc-snapshot_include_hud = keep worn HUD attachments in saved snapshots
setting-desc-snapshot_include_ui = keep the viewer UI in saved snapshots
setting-desc-spacenav-avatar-axis-dead-zone = Avatar-motion axis dead zone
setting-desc-spacenav-avatar-axis-scale = Avatar-motion axis scaler
setting-desc-spacenav-flycam-axis-dead-zone = Flycam axis dead zone
setting-desc-spacenav-flycam-axis-scale = Flycam axis scaler
setting-desc-statusbar_show_coordinates = Show the agent's region-local coordinates in the status area's location read-out
setting-desc-stopim_endsession_remote = Sent to the remote party when they attempt to forcefully close the IM conversation (and it exists)
setting-desc-stopim_nosession = Sent to the remote party when they attempt to forcefully close your IM conversation with them (and no such session exists)
setting-desc-table-column-widths = Table column widths (token:px, …).
