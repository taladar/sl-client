...
//! [`crate::objects::recenter_objects`] / [`crate::avatars::recenter_avatars`] /
//! [`crate::terrain::recenter_terrain`]). A **distant** teleport instead mints a
...
/// shift.
pub(crate) fn reset_scene_on_world_reset(
