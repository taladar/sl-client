---
id: viewer-notification-catalogue-voice
title: Notification catalogue — voice entries
topic: viewer
status: done
...
Port the **voice** notifications from the reference `notifications.xml` into the
...
confirm entries. These cover voice chat / WebRTC.

The exact entry set is the **23** rows tagged `family:voice` with
...
Ported as part of the consolidated remaining-families port (23
