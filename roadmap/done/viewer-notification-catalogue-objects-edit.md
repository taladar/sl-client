---
id: viewer-notification-catalogue-objects-edit
title: Notification catalogue — object build / edit / rez entries
topic: viewer
status: done
...
Port the **object build / edit / rez** notifications from the reference
...
generic server-alert and shared-confirm entries. These cover building, editing,
rezzing, returning, deleting and taking objects, and land-impact limits.

The exact entry set is the **201** rows tagged `family:objects-edit` with
...
Ported as part of the consolidated remaining-families port (202
