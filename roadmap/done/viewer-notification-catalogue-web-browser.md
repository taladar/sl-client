...
Ported as part of the consolidated remaining-families port (13
...
`AuthRequest` stays `followup`: it needs two input fields
(username + masked password), which the toast form model does not
carry yet.
