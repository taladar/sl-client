---
id: viewer-notification-catalogue-marketplace
title: Notification catalogue — marketplace entries
topic: viewer
status: done
...
Port the **marketplace** notifications from the reference `notifications.xml`
...
shared-confirm entries. These cover marketplace listings and the merchant
outbox.

The exact entry set is the **27** rows tagged `family:marketplace` with
...
Ported as part of the consolidated remaining-families port (27
