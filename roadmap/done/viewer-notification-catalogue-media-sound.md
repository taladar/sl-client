---
id: viewer-notification-catalogue-media-sound
title: Notification catalogue — media & sound entries
topic: viewer
status: done
...
Port the **media & sound** notifications from the reference `notifications.xml`
...
shared-confirm entries. These cover parcel media, streaming audio / video and
sound assets.

The exact entry set is the **31** rows tagged `family:media-sound` with
