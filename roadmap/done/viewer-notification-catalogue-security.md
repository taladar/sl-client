---
id: viewer-notification-catalogue-security
title: Notification catalogue — security entries
topic: viewer
status: done
...
Port the **security** notifications from the reference `notifications.xml` into
...
confirm entries. These cover security warnings, age verification, phishing and
key handling.

The exact entry set is the **15** rows tagged `family:security` with
...
Ported as part of the consolidated remaining-families port (15
