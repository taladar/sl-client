---
id: viewer-notification-catalogue-premium-account
title: Notification catalogue — premium / account entries
topic: viewer
status: done
...
Port the **premium / account** notifications from the reference
...
generic server-alert and shared-confirm entries. These cover premium /
membership, display- / user-name change and billing.

The exact entry set is the **11** rows tagged `family:premium-account` with
...
Ported as part of the consolidated remaining-families port (11
