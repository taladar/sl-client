---
id: viewer-notification-catalogue-landmarks-navigation
title: Notification catalogue — landmarks & navigation entries
topic: viewer
status: done
...
Port the **landmarks & navigation** notifications from the reference
...
generic server-alert and shared-confirm entries. These cover landmarks, the
world map, search, events and places.

The exact entry set is the **21** rows tagged `family:landmarks-navigation` with
...
Ported as part of the consolidated remaining-families port (22
