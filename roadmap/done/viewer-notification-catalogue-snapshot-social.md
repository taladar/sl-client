---
id: viewer-notification-catalogue-snapshot-social
title: Notification catalogue — snapshot & social entries
topic: viewer
status: done
...
Port the **snapshot & social** notifications from the reference
...
generic server-alert and shared-confirm entries. These cover snapshot save /
upload, postcards, the profile feed and sharing.

The exact entry set is the **45** rows tagged `family:snapshot-social` with
...
Ported as part of the consolidated remaining-families port (45
