---
id: viewer-notification-catalogue-experiences
title: Notification catalogue — experiences entries
topic: viewer
status: done
...
Port the **experiences** notifications from the reference `notifications.xml`
...
shared-confirm entries. These cover experience permissions, the key-value store
and trust, beyond the already-done bespoke experience prompt.

The exact entry set is the **10** rows tagged `family:experiences` with
...
Ported as part of the consolidated remaining-families port (10
