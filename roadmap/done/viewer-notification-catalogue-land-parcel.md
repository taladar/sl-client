---
id: viewer-notification-catalogue-land-parcel
title: Notification catalogue — land / parcel entries
topic: viewer
status: done
...
Port the **land / parcel** notifications from the reference `notifications.xml`
...
shared-confirm entries. These cover parcel about / buy / sell / divide / access
/ covenant and ban-line handling.

The exact entry set is the **92** rows tagged `family:land-parcel` with
...
Ported as part of the consolidated remaining-families port (94
