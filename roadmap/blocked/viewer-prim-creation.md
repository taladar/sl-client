...
Create new in-world prims: a create / build tool mode (hosted in the edit
floater / tool shell, [[viewer-object-edit-floater-shell]]), pick a base prim
type, and rez a default prim at a ray-cast build point on a surface. This is the
