---
id: test-friendship-terminate-aditi
title: Friendship terminate — [aditi] variant
topic: test
status: ready
...
Add the `[aditi]` variant of the `friendship-terminate` case
(`[[test-friendship-terminate]]`, already green `[opensim]`). The multi-avatar
