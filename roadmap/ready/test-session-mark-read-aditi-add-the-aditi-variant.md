---
id: test-session-mark-read-aditi
title: Session mark-read — [aditi] variant
topic: test
status: ready
...
Add the `[aditi]` variant of the `session-mark-read` case
(`[[test-session-mark-read]]`, already green `[opensim]`). The multi-avatar
