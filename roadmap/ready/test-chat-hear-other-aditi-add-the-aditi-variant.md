---
id: test-chat-hear-other-aditi
title: Chat hear other — [aditi] variant
topic: test
status: ready
...
Add the `[aditi]` variant of the `chat-hear-other` case
(`[[test-chat-hear-other]]`, already green `[opensim]`). The multi-avatar
