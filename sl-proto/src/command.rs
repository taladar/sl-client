...
impl Command {
    /// The command's variant name, as a stable `&'static str` (`"DeleteObjects"`
    /// for [`Command::DeleteObjects`]).
    ///
    /// An I/O driver uses it to label a command whose send failed, so the
    /// failure can be reported to the user (and logged) naming the action that
    /// did not happen. The match is exhaustive on purpose: a new variant fails
    /// to compile until it is named here.
    #[must_use]
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            Self::RequestAvatarProperties(..) => "RequestAvatarProperties",
            Self::RequestAvatarPicks(..) => "RequestAvatarPicks",
            Self::RequestAvatarNotes(..) => "RequestAvatarNotes",
            Self::RequestAvatarClassifieds(..) => "RequestAvatarClassifieds",
            Self::RequestPickInfo { .. } => "RequestPickInfo",
            Self::RequestClassifiedInfo(..) => "RequestClassifiedInfo",
            Self::UpdateProfile(..) => "UpdateProfile",
            Self::UpdateInterests(..) => "UpdateInterests",
            Self::UpdateAvatarNotes { .. } => "UpdateAvatarNotes",
            Self::UpdatePick(..) => "UpdatePick",
            Self::DeletePick(..) => "DeletePick",
            Self::GodDeletePick { .. } => "GodDeletePick",
            Self::UpdateClassified(..) => "UpdateClassified",
            Self::DeleteClassified(..) => "DeleteClassified",
            Self::GodDeleteClassified { .. } => "GodDeleteClassified",
            Self::RequestFolderContents(..) => "RequestFolderContents",
            Self::FetchInventoryFolders(..) => "FetchInventoryFolders",
            Self::QueryInventoryFolder { .. } => "QueryInventoryFolder",
            Self::QueryInventoryRoots => "QueryInventoryRoots",
            Self::QueryInventoryFolders => "QueryInventoryFolders",
            Self::CreateInventoryFolder { .. } => "CreateInventoryFolder",
            Self::UpdateInventoryFolder { .. } => "UpdateInventoryFolder",
            Self::MoveInventoryFolder { .. } => "MoveInventoryFolder",
            Self::RemoveInventoryFolders(..) => "RemoveInventoryFolders",
            Self::CreateInventoryItem(..) => "CreateInventoryItem",
            Self::CreateScript { .. } => "CreateScript",
            Self::LinkInventoryItem(..) => "LinkInventoryItem",
            Self::UpdateInventoryItem { .. } => "UpdateInventoryItem",
            Self::MoveInventoryItem { .. } => "MoveInventoryItem",
            Self::CopyInventoryItem { .. } => "CopyInventoryItem",
            Self::RemoveInventoryItems(..) => "RemoveInventoryItems",
            Self::ChangeInventoryItemFlags { .. } => "ChangeInventoryItemFlags",
            Self::PurgeInventoryDescendents(..) => "PurgeInventoryDescendents",
            Self::RemoveInventoryObjects { .. } => "RemoveInventoryObjects",
            Self::CreateInventoryCategory { .. } => "CreateInventoryCategory",
            Self::Ais3CreateFolder { .. } => "Ais3CreateFolder",
            Self::Ais3RenameFolder { .. } => "Ais3RenameFolder",
            Self::Ais3MoveFolder { .. } => "Ais3MoveFolder",
            Self::Ais3RemoveFolder(..) => "Ais3RemoveFolder",
            Self::Ais3PurgeFolder(..) => "Ais3PurgeFolder",
            Self::Ais3FetchFolderChildren { .. } => "Ais3FetchFolderChildren",
            Self::Ais3UpdateItem { .. } => "Ais3UpdateItem",
            Self::Ais3MoveItem { .. } => "Ais3MoveItem",
            Self::Ais3RemoveItem(..) => "Ais3RemoveItem",
            Self::Ais3FetchItem(..) => "Ais3FetchItem",
            Self::GrantUserRights { .. } => "GrantUserRights",
            Self::OfferFriendship { .. } => "OfferFriendship",
            Self::TerminateFriendship(..) => "TerminateFriendship",
            Self::AcceptFriendship { .. } => "AcceptFriendship",
            Self::DeclineFriendship(..) => "DeclineFriendship",
            Self::OfferCallingCard { .. } => "OfferCallingCard",
            Self::AcceptCallingCard { .. } => "AcceptCallingCard",
            Self::DeclineCallingCard(..) => "DeclineCallingCard",
            Self::ActivateGroup(..) => "ActivateGroup",
            Self::RequestGroupMembers(..) => "RequestGroupMembers",
            Self::FetchGroupMembers(..) => "FetchGroupMembers",
            Self::RequestGroupRoles(..) => "RequestGroupRoles",
            Self::RequestGroupRoleMembers(..) => "RequestGroupRoleMembers",
            Self::RequestGroupTitles(..) => "RequestGroupTitles",
            Self::RequestGroupProfile(..) => "RequestGroupProfile",
            Self::RequestGroupNotices(..) => "RequestGroupNotices",
            Self::RequestGroupNotice(..) => "RequestGroupNotice",
            Self::CreateGroup(..) => "CreateGroup",
            Self::UpdateGroupInfo(..) => "UpdateGroupInfo",
            Self::UpdateGroupTitle { .. } => "UpdateGroupTitle",
            Self::JoinGroup(..) => "JoinGroup",
            Self::LeaveGroup(..) => "LeaveGroup",
            Self::InviteToGroup { .. } => "InviteToGroup",
            Self::AcceptGroupInvitation { .. } => "AcceptGroupInvitation",
            Self::DeclineGroupInvitation { .. } => "DeclineGroupInvitation",
            Self::SetGroupAcceptNotices { .. } => "SetGroupAcceptNotices",
            Self::SetGroupContribution { .. } => "SetGroupContribution",
            Self::StartGroupSession(..) => "StartGroupSession",
            Self::SendGroupMessage { .. } => "SendGroupMessage",
            Self::LeaveGroupSession(..) => "LeaveGroupSession",
            Self::UpdateGroupRoles { .. } => "UpdateGroupRoles",
            Self::ChangeGroupRoleMembers { .. } => "ChangeGroupRoleMembers",
            Self::EjectGroupMembers { .. } => "EjectGroupMembers",
            Self::RequestGroupAccountSummary { .. } => "RequestGroupAccountSummary",
            Self::RequestGroupAccountDetails { .. } => "RequestGroupAccountDetails",
            Self::RequestGroupAccountTransactions { .. } => "RequestGroupAccountTransactions",
            Self::RequestGroupActiveProposals { .. } => "RequestGroupActiveProposals",
            Self::RequestGroupVoteHistory { .. } => "RequestGroupVoteHistory",
            Self::StartGroupProposal { .. } => "StartGroupProposal",
            Self::GroupProposalBallot { .. } => "GroupProposalBallot",
            Self::SendGroupNotice { .. } => "SendGroupNotice",
            Self::ReplyScriptDialog { .. } => "ReplyScriptDialog",
            Self::AnswerScriptPermissions { .. } => "AnswerScriptPermissions",
            Self::RequestMuteList => "RequestMuteList",
            Self::Mute { .. } => "Mute",
            Self::Unmute { .. } => "Unmute",
            Self::Teleport { .. } => "Teleport",
            Self::RequestRegionInfo => "RequestRegionInfo",
            Self::RequestAvatarNames(..) => "RequestAvatarNames",
            Self::RequestGroupNames(..) => "RequestGroupNames",
            Self::RequestDisplayNames(..) => "RequestDisplayNames",
            ...
            Self::RequestAttachmentResources => "RequestAttachmentResources",
            Self::RequestLandResources { .. } => "RequestLandResources",
            ...
            Self::ModifyLand(..) => "ModifyLand",
            Self::UndoLand => "UndoLand",
            Self::UpdateParcel(..) => "UpdateParcel",
            Self::RequestParcelAccessList { .. } => "RequestParcelAccessList",
            Self::UpdateParcelAccessList { .. } => "UpdateParcelAccessList",
            Self::RequestParcelDwell { .. } => "RequestParcelDwell",
            Self::BuyParcel { .. } => "BuyParcel",
            Self::ReturnParcelObjects { .. } => "ReturnParcelObjects",
            Self::SelectParcelObjects { .. } => "SelectParcelObjects",
            Self::DeedParcelToGroup { .. } => "DeedParcelToGroup",
            Self::ReclaimParcel { .. } => "ReclaimParcel",
            Self::ReleaseParcel { .. } => "ReleaseParcel",
            Self::JoinParcels { .. } => "JoinParcels",
            Self::DivideParcel { .. } => "DivideParcel",
            Self::RequestParcelObjectOwners { .. } => "RequestParcelObjectOwners",
            Self::BuyParcelPass { .. } => "BuyParcelPass",
            Self::DisableParcelObjects { .. } => "DisableParcelObjects",
            Self::RequestParcelInfo { .. } => "RequestParcelInfo",
            Self::RequestRemoteParcelId { .. } => "RequestRemoteParcelId",
            Self::RequestEstateInfo => "RequestEstateInfo",
            Self::RequestRegionTerrainDownload { .. } => "RequestRegionTerrainDownload",
            Self::RequestRegionTerrainUpload { .. } => "RequestRegionTerrainUpload",
            Self::UpdateEstateAccess { .. } => "UpdateEstateAccess",
            Self::KickEstateUser { .. } => "KickEstateUser",
            Self::TeleportHomeUser { .. } => "TeleportHomeUser",
            Self::TeleportHomeAllUsers => "TeleportHomeAllUsers",
            Self::RestartRegion { .. } => "RestartRegion",
            Self::SendEstateMessage { .. } => "SendEstateMessage",
            ...
            Self::ConnectTelehub { .. } => "ConnectTelehub",
            Self::DisconnectTelehub => "DisconnectTelehub",
            Self::AddTelehubSpawnPoint { .. } => "AddTelehubSpawnPoint",
            Self::RemoveTelehubSpawnPoint { .. } => "RemoveTelehubSpawnPoint",
            Self::GodKickUser { .. } => "GodKickUser",
            Self::SendGodlikeMessage { .. } => "SendGodlikeMessage",
            Self::RequestMoneyBalance => "RequestMoneyBalance",
            Self::RequestEconomyData => "RequestEconomyData",
            Self::SendMoneyTransfer { .. } => "SendMoneyTransfer",
            Self::SetDrawDistance(..) => "SetDrawDistance",
            Self::RequestMapBlocks { .. } => "RequestMapBlocks",
            Self::RequestMapByName { .. } => "RequestMapByName",
            Self::RequestMapItems { .. } => "RequestMapItems",
            Self::RequestMapLayer => "RequestMapLayer",
            Self::SendAbuseReport(..) => "SendAbuseReport",
            Self::SendAbuseReportViaCaps { .. } => "SendAbuseReportViaCaps",
            Self::SendPostcard(..) => "SendPostcard",
            Self::RequestObjects { .. } => "RequestObjects",
            Self::ResendCachedObjects { .. } => "ResendCachedObjects",
            Self::RequestObjectProperties { .. } => "RequestObjectProperties",
            Self::DeselectObjects { .. } => "DeselectObjects",
            Self::TouchObject { .. } => "TouchObject",
            Self::GrabObject { .. } => "GrabObject",
            Self::GrabObjectUpdate { .. } => "GrabObjectUpdate",
            Self::DegrabObject { .. } => "DegrabObject",
            Self::RezObject { .. } => "RezObject",
            Self::DuplicateObjects { .. } => "DuplicateObjects",
            Self::DeleteObjects { .. } => "DeleteObjects",
            Self::DerezObjects { .. } => "DerezObjects",
            Self::UpdateObject { .. } => "UpdateObject",
            Self::SetObjectName { .. } => "SetObjectName",
            Self::SetObjectDescription { .. } => "SetObjectDescription",
            Self::SetObjectClickAction { .. } => "SetObjectClickAction",
            Self::SetObjectMaterial { .. } => "SetObjectMaterial",
            Self::SetObjectFlags { .. } => "SetObjectFlags",
            Self::SetObjectShape { .. } => "SetObjectShape",
            Self::SetObjectImage { .. } => "SetObjectImage",
            Self::SetObjectExtraParams { .. } => "SetObjectExtraParams",
            Self::SetObjectGroup { .. } => "SetObjectGroup",
            Self::DeedObjectsToGroup { .. } => "DeedObjectsToGroup",
            Self::SetObjectPermissions { .. } => "SetObjectPermissions",
            Self::SetObjectForSale { .. } => "SetObjectForSale",
            Self::SetObjectCategory { .. } => "SetObjectCategory",
            Self::SetObjectIncludeInSearch { .. } => "SetObjectIncludeInSearch",
            Self::LinkObjects { .. } => "LinkObjects",
            Self::DelinkObjects { .. } => "DelinkObjects",
            Self::UndoObjects { .. } => "UndoObjects",
            Self::RedoObjects { .. } => "RedoObjects",
            Self::BuyObject { .. } => "BuyObject",
            Self::BuyObjectInventory { .. } => "BuyObjectInventory",
            Self::RequestPayPrice { .. } => "RequestPayPrice",
            Self::RequestObjectPropertiesFamily { .. } => "RequestObjectPropertiesFamily",
            Self::SpinObjectStart { .. } => "SpinObjectStart",
            Self::SpinObjectUpdate { .. } => "SpinObjectUpdate",
            Self::SpinObjectStop { .. } => "SpinObjectStop",
            Self::DuplicateObjectsOnRay { .. } => "DuplicateObjectsOnRay",
            Self::RezRestoreToWorld { .. } => "RezRestoreToWorld",
            Self::RezObjectFromNotecard { .. } => "RezObjectFromNotecard",
            Self::CopyInventoryFromNotecard { .. } => "CopyInventoryFromNotecard",
            Self::RezObjectFromInventory { .. } => "RezObjectFromInventory",
            Self::RezScript { .. } => "RezScript",
            Self::RevokeScriptPermissions { .. } => "RevokeScriptPermissions",
            Self::DetachAttachmentIntoInventory { .. } => "DetachAttachmentIntoInventory",
            Self::RequestTaskInventory { .. } => "RequestTaskInventory",
            Self::FetchTaskInventory { .. } => "FetchTaskInventory",
            Self::RequestXfer { .. } => "RequestXfer",
            Self::FetchTaskItemAsset { .. } => "FetchTaskItemAsset",
            Self::FetchEstateCovenantAsset => "FetchEstateCovenantAsset",
            Self::UpdateTaskInventory { .. } => "UpdateTaskInventory",
            Self::MoveTaskInventory { .. } => "MoveTaskInventory",
            Self::RemoveTaskInventory { .. } => "RemoveTaskInventory",
            Self::RequestScriptRunning { .. } => "RequestScriptRunning",
            Self::SetScriptRunning { .. } => "SetScriptRunning",
            Self::ResetScript { .. } => "ResetScript",
            Self::RequestTexture { .. } => "RequestTexture",
            Self::FetchTexture { .. } => "FetchTexture",
            Self::FetchMesh { .. } => "FetchMesh",
            Self::FetchAsset { .. } => "FetchAsset",
            Self::RequestWearables => "RequestWearables",
            Self::SetWearing(..) => "SetWearing",
            ...
            Self::ActivateGestures { .. } => "ActivateGestures",
            Self::DeactivateGestures { .. } => "DeactivateGestures",
            Self::SetAlwaysRun { .. } => "SetAlwaysRun",
            Self::PauseAgent => "PauseAgent",
            Self::ResumeAgent => "ResumeAgent",
            Self::SetAgentFov { .. } => "SetAgentFov",
            Self::SetAgentSize { .. } => "SetAgentSize",
            Self::ReleaseScriptControls => "ReleaseScriptControls",
            Self::QueryScriptPermissions => "QueryScriptPermissions",
            ...
            Self::TrackAgent { .. } => "TrackAgent",
            Self::FindAgent { .. } => "FindAgent",
            Self::DirFindQuery { .. } => "DirFindQuery",
            Self::DirPlacesQuery { .. } => "DirPlacesQuery",
            Self::DirLandQuery { .. } => "DirLandQuery",
            Self::DirClassifiedQuery { .. } => "DirClassifiedQuery",
            Self::AvatarPickerRequest { .. } => "AvatarPickerRequest",
            Self::PlacesQuery { .. } => "PlacesQuery",
            Self::EventInfoRequest { .. } => "EventInfoRequest",
            Self::EventNotificationAddRequest { .. } => "EventNotificationAddRequest",
            Self::EventNotificationRemoveRequest { .. } => "EventNotificationRemoveRequest",
            Self::UploadAsset { .. } => "UploadAsset",
            Self::UploadBakedTexture { .. } => "UploadBakedTexture",
            Self::UpdateInventoryAsset { .. } => "UpdateInventoryAsset",
            Self::SaveInventoryAsset { .. } => "SaveInventoryAsset",
            Self::UploadScript { .. } => "UploadScript",
            Self::RequestObjectMedia { .. } => "RequestObjectMedia",
            Self::SetObjectMedia { .. } => "SetObjectMedia",
            Self::NavigateObjectMedia { .. } => "NavigateObjectMedia",
            Self::RequestRenderMaterials { .. } => "RequestRenderMaterials",
            Self::SetRenderMaterials { .. } => "SetRenderMaterials",
            Self::ModifyMaterialParams { .. } => "ModifyMaterialParams",
            Self::RequestVoiceAccount { .. } => "RequestVoiceAccount",
            Self::RequestParcelVoiceInfo => "RequestParcelVoiceInfo",
            Self::SendVoiceSignaling { .. } => "SendVoiceSignaling",
            Self::RequestExperienceInfo { .. } => "RequestExperienceInfo",
            Self::FindExperiences { .. } => "FindExperiences",
            Self::RequestExperiencePermissions => "RequestExperiencePermissions",
            Self::SetExperiencePermission { .. } => "SetExperiencePermission",
            Self::RequestOwnedExperiences => "RequestOwnedExperiences",
            Self::RequestAdminExperiences => "RequestAdminExperiences",
            Self::RequestCreatorExperiences => "RequestCreatorExperiences",
            Self::RequestGroupExperiences { .. } => "RequestGroupExperiences",
            Self::RequestExperienceAdmin { .. } => "RequestExperienceAdmin",
            Self::RequestExperienceContributor { .. } => "RequestExperienceContributor",
            ...
            Self::RequestTeleport { .. } => "RequestTeleport",
            Self::GiveInventory { .. } => "GiveInventory",
            Self::GiveInventoryFolder { .. } => "GiveInventoryFolder",
            Self::AcceptInventoryOffer { .. } => "AcceptInventoryOffer",
            Self::DeclineInventoryOffer { .. } => "DeclineInventoryOffer",
            Self::StartConference { .. } => "StartConference",
            Self::InviteToChatSession { .. } => "InviteToChatSession",
            Self::SendConferenceMessage { .. } => "SendConferenceMessage",
            Self::LeaveConference { .. } => "LeaveConference",
            Self::MarkSessionRead { .. } => "MarkSessionRead",
            Self::AcceptChatInvite { .. } => "AcceptChatInvite",
            Self::DeclineChatInvite { .. } => "DeclineChatInvite",
            Self::JoinSessionVoice { .. } => "JoinSessionVoice",
            Self::LeaveSessionVoice { .. } => "LeaveSessionVoice",
            Self::QueryChatSessions => "QueryChatSessions",
            Self::QueryChatHistoryPage { .. } => "QueryChatHistoryPage",
            Self::QueryNearbyChatHistoryPage { .. } => "QueryNearbyChatHistoryPage",
            Self::FetchSessionHistory { .. } => "FetchSessionHistory",
            Self::QueryFriends => "QueryFriends",
            Self::RetrieveInstantMessages => "RetrieveInstantMessages",
            Self::RequestOfflineMessages => "RequestOfflineMessages",
            Self::TeleportViaLandmark { .. } => "TeleportViaLandmark",
            Self::CancelTeleport => "CancelTeleport",
            Self::SetStartLocation { .. } => "SetStartLocation",
            Self::RequestAgentDataUpdate => "RequestAgentDataUpdate",
            Self::QuitCopy => "QuitCopy",
            ...
            Self::EjectUser { .. } => "EjectUser",
            Self::FreezeUser { .. } => "FreezeUser",
            Self::SimWideDeletes { .. } => "SimWideDeletes",
            Self::GodUpdateRegionInfo { .. } => "GodUpdateRegionInfo",
            Self::ParcelGodForceOwner { .. } => "ParcelGodForceOwner",
            Self::ParcelGodMarkAsContent { .. } => "ParcelGodMarkAsContent",
            Self::EventGodDelete { .. } => "EventGodDelete",
            Self::StateSave { .. } => "StateSave",
            Self::ViewerStartAuction { .. } => "ViewerStartAuction",
            Self::MarketplaceMerchantStatus => "MarketplaceMerchantStatus",
            Self::MarketplaceListings => "MarketplaceListings",
            Self::MarketplaceListing(..) => "MarketplaceListing",
            Self::MarketplaceCreateListing(..) => "MarketplaceCreateListing",
            Self::MarketplaceUpdateListing(..) => "MarketplaceUpdateListing",
            Self::MarketplaceAssociateListing(..) => "MarketplaceAssociateListing",
            Self::MarketplaceDeleteListing(..) => "MarketplaceDeleteListing",
            Self::Logout => "Logout",
        }
    }
}
...
mod tests {
    ...
    /// [`Command::name`] is a hand-written 350-arm match, so the risk is a
    /// copy-paste: a variant labelled with its neighbour's name. `Debug` prints
    /// the variant's own identity first, so comparing the two catches exactly
    /// that, across all three variant shapes (unit, tuple, struct-like).
    #[test]
    fn name_agrees_with_the_debug_variant() {
        let samples = [
            Command::Logout,
            Command::Stand,
            Command::SitOnGround,
            Command::Typing(true),
            Command::ActivateGroup(None),
        ...
        for command in samples {
            ...
            assert!(
                debug.starts_with(command.name()),
                "name() said {:?} but Debug printed {debug}",
                command.name()
            );
        }
    }

    /// The names an I/O driver labels a failed send with must be distinct, or
    /// two different actions would report the same failure.
    #[test]
    fn sample_names_are_distinct() {
        let names = [
            Command::Logout.name(),
            Command::Stand.name(),
            Command::SitOnGround.name(),
            Command::Typing(true).name(),
        ];
        ...
        deduped.dedup();
        assert_eq!(deduped.len(), unique, "two commands share a name");
    }
}
