...
pub use session::{
    ...
    LegacyPresetError, MessageCursor, NearbyHistoryLine, PendingInvite, RECV_BUFFER_SIZE,
    ...
    group_memberships_to_caps_llsd, inventory_descendents_to_llsd, legacy_preset_from_bytes,
