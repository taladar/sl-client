...
pub use session::{
    ...
    CAP_UPDATE_AVATAR_APPEARANCE, CAP_UPDATE_GESTURE_AGENT_INVENTORY,
...
pub use sl_wire::{
    ...
    GLTF_MATERIAL_OVERRIDE_METHOD, GltfMaterialOverride, LegacyMaterial, Llsd, LoginRequest,
    ...
    ParcelFlags, RegionFlags, RenderMaterialEntry, WireError, build_event_queue_request,
    ...
    build_upload_baked_texture_request, combine_uuids, parse_asset_upload_response,
