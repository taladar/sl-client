...
use bevy::prelude::*;
use sl_client_bevy::{
    ChatLogConfig, ClientDirectories, Command, Distance, InventoryCacheConfig, LoginParams,
    LoginRequest, SessionDisconnectReason, SlClientPlugin, SlCommand, SlEvent, SlSessionEvent,
};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let start = env_or("SL_START", "last").parse::<sl_client_bevy::StartLocation>()?;
