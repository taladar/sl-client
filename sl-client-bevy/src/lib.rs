...
pub use sl_proto::{
    ...
    PrimShape, PrimShapeParams, ProductType, ProfileUpdate, ReflectionProbe, ReflectionProbeFlags,
    RegionChatSettings, RegionCombatSettings, RegionFlags, RegionHandle, RegionHandleError,
    RegionIdentity, RegionInfoUpdate, RegionLimits, Reliability, RenderMaterialEntry,
    RenderMaterialRef, Rotation, SaleType, ScriptControl, ScriptControlAction, ScriptDialog,
