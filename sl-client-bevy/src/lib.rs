...
pub use sl_proto::{
    ...
    ParticleSystem, PermissionField, PickInfo, PickUpdate, PlayingAnimation, PrimShape,
    ...
    SoundPreload, TerrainLayerType, TerrainPatch, TextureAnimation, TextureEntry, TextureFace,
    Throttle, Transmit, Uuid, Vector, VoiceAccountInfo, VoiceProvisionRequest, Wearable,
