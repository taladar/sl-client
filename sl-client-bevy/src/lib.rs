...
pub use sl_proto::{
    ...
    ObjectPhysicsData, ObjectPlayingAnimation, ObjectProperties, ObjectPropertiesFamily,
    ObjectTransform, OpenRegionInfo, OpenSimExtras, OwnerKey, ParcelAccessEntry, ParcelAccessFlags,
