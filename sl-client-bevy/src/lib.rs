...
pub use sl_proto::{
    ...
    AgentPreferences, AnimatedObjects, AnimationKey, AnyMessage, AssetKey, AssetUpdateLocation,
    AssociateInventory, AttachmentMode, AttachmentPoint, AvatarAppearance, AvatarClassified,
