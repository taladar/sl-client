...
pub use sl_proto::{
    ...
    EnvironmentPushAction, EnvironmentSettings, Error as SessionError, EstateAccessDelta,
    EstateAccessKind, EstateCovenant, EstateFlags, EstateInfo, EstateInfoUpdate, EventId,
    EventInfo, ExperienceEnvironmentPush, ExperienceEvent, ExperienceEventPermission,
    ExperienceInfo, ExperienceKey, ExperiencePermission, ExperienceProperties, ExperienceUpdate,
    ExtendedMesh, FaceMaterialPut, FlexibleData, FolderInfo, FolderState, FolderType, Friend,
    FriendKey, FriendPresence, FriendRights, GestureActivation, GlobalCoordinates, Glow,
    GltfMaterialOverride, GridCoordinates, GroupInvitationReceived, GroupKey, GroupMember,
    GroupMembership, GroupNotice, GroupNoticeAttachment, GroupNoticeItem, GroupNoticeKey,
    GroupNoticeReceived, GroupProfile, GroupRequestId, GroupRole, GroupRoleChange, GroupRoleEdit,
