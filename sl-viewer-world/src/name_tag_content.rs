...
impl NameTagStatuses {
    ...
    #[must_use]
    pub fn is_typing(&self, agent: AgentKey) -> bool {
...
pub static AWAY_ANIM: std::sync::LazyLock<Option<sl_client_bevy::Uuid>> =
