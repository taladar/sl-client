...
pub struct AvatarComplexityModel {
...
impl AvatarComplexityModel {
    ...
    #[must_use]
    pub fn complexity(&self, agent: AgentKey) -> Option<AvatarComplexity> {
    ...
    #[must_use]
    pub fn jelly_reason_for(&self, agent: AgentKey) -> Option<JellyReason> {
...
pub struct AvatarComplexityPlugin;
