...
impl GpuCrowd {
    ...
    #[must_use]
    pub const fn awaiting_trigger(&self) -> bool {
    ...
    #[must_use]
    pub const fn visible_parts(&self) -> usize {
        self.visible_parts
    }
    ...
    pub const fn request_spawn(&mut self) {
...
/// sparse adjuster corrections — so `stage_gpu_avatars`
