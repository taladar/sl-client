...
pub struct AvatarRenderSettings {
...
impl AvatarRenderSettings {
    ...
    #[must_use]
    pub fn entries(&self) -> &[RenderException] {
        &self.entries
    }
    ...
    #[must_use]
    pub fn setting_of(&self, agent: AgentKey) -> RenderOverride {
    ...
    pub fn live_name(&self, agent: AgentKey) -> Option<&str> {
    ...
    pub fn set(&mut self, agent: AgentKey, setting: RenderOverride, name: &str, now: i64) {
        let held = self
            .entries
            .iter_mut()
...
pub struct RequestRenderException {
...
mod tests {
    ...
    pub(crate) fn agent(id: u128) -> AgentKey {
