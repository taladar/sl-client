...
const fn event_name(event: &Event) -> &'static str {
    match event {
        ...
        Event::GenericMessage(..) => "generic_message",
        Event::LargeGenericMessage(..) => "large_generic_message",
        Event::GenericStreamingMessage(..) => "generic_streaming_message",
        Event::ServerError(..) => "server_error",
        Event::FeatureDisabled(..) => "feature_disabled",
        Event::Kicked(..) => "kicked",
        ...
        Event::FriendshipTerminated { .. } => "friendship_terminated",
        Event::CallingCardOffered { .. } => "calling_card_offered",
        Event::CallingCardAccepted { .. } => "calling_card_accepted",
        Event::CallingCardDeclined { .. } => "calling_card_declined",
        Event::InventoryItemsRemoved { .. } => "inventory_items_removed",
        Event::InventoryFoldersRemoved { .. } => "inventory_folders_removed",
        Event::InventoryObjectsRemoved { .. } => "inventory_objects_removed",
        Event::InventoryItemsMoved { .. } => "inventory_items_moved",
        Event::TaskInventoryReply(..) => "task_inventory_reply",
        Event::TaskInventoryContents { .. } => "task_inventory_contents",
        Event::XferDownloaded { .. } => "xfer_downloaded",
        ...
        Event::UserInfo(..) => "user_info",
        Event::DeRezAck { .. } => "derez_ack",
        Event::ForceObjectSelect { .. } => "force_object_select",
        Event::GodlikePowersGranted { .. } => "godlike_powers_granted",
        ...
        Event::ChatSessionStarted { .. } => "chat_session_started",
        ...
        Event::ScriptPermissionState(..) => "script_permission_state",
        Event::ChatSessions(..) => "chat_sessions",
        Event::ChatHistoryPage { .. } => "chat_history_page",
        Event::NearbyChatHistoryPage { .. } => "nearby_chat_history_page",
        Event::SessionServerHistory { .. } => "session_server_history",
        Event::FriendsSnapshot(..) => "friends_snapshot",
        Event::InventoryFolderPage { .. } => "inventory_folder_page",
        Event::InventoryRoots { .. } => "inventory_roots",
        Event::InventoryFolders(..) => "inventory_folders",
        ...
        Event::InventoryAssetSaved { .. } => "inventory_asset_saved",
        Event::AssetUploadFailed { .. } => "asset_upload_failed",
        Event::ScriptUploaded { .. } => "script_uploaded",
        ...
        Event::CofVersionIncremented { .. } => "cof_version_incremented",
        ...
        Event::AgentDroppedFromGroup { .. } => "agent_dropped_from_group",
        Event::DisplayNameUpdate(..) => "display_name_update",
        Event::SetDisplayNameReply(..) => "set_display_name_reply",
        Event::WindLightRefresh { .. } => "wind_light_refresh",
        Event::SimConsoleResponse { .. } => "sim_console_response",
        Event::RequiredVoiceVersion(..) => "required_voice_version",
        Event::OpenRegionInfo(..) => "open_region_info",
        ...
        Event::MarketplaceMerchantStatus(..) => "marketplace_merchant_status",
        Event::MarketplaceListings(..) => "marketplace_listings",
        Event::MarketplaceListing(..) => "marketplace_listing",
        Event::MarketplaceListingCreated(..) => "marketplace_listing_created",
        Event::MarketplaceListingUpdated(..) => "marketplace_listing_updated",
        Event::MarketplaceInventoryAssociated(..) => "marketplace_inventory_associated",
        Event::MarketplaceListingDeleted(..) => "marketplace_listing_deleted",
        Event::MarketplaceListingGone(..) => "marketplace_listing_gone",
        Event::MarketplaceError { .. } => "marketplace_error",
...
const fn command_name(command: &Command) -> &'static str {
    match command {
        ...
        Command::LinkInventoryItem(..) => "link_inventory_item",
        Command::UpdateInventoryItem { .. } => "update_inventory_item",
        Command::SaveInventoryAsset { .. } => "save_inventory_asset",
        ...
        Command::OfferCallingCard { .. } => "offer_calling_card",
        Command::AcceptCallingCard { .. } => "accept_calling_card",
        Command::DeclineCallingCard(..) => "decline_calling_card",
        ...
        Command::UpdateGroupInfo(..) => "update_group_info",
        Command::UpdateGroupTitle { .. } => "update_group_title",
        ...
        Command::ModifyLand(..) => "modify_land",
        Command::UndoLand => "undo_land",
        ...
        Command::RequestRegionTerrainDownload { .. } => "request_region_terrain_download",
        Command::RequestRegionTerrainUpload { .. } => "request_region_terrain_upload",
        ...
        Command::SetObjectShape { .. } => "set_object_shape",
        ...
        Command::DetachAttachmentIntoInventory { .. } => "detach_attachment_into_inventory",
        Command::RequestTaskInventory { .. } => "request_task_inventory",
        Command::FetchTaskInventory { .. } => "fetch_task_inventory",
        Command::FetchTaskItemAsset { .. } => "fetch_task_item_asset",
        Command::FetchEstateCovenantAsset => "fetch_estate_covenant_asset",
        Command::RequestXfer { .. } => "request_xfer",
        Command::UpdateTaskInventory { .. } => "update_task_inventory",
        Command::MoveTaskInventory { .. } => "move_task_inventory",
        Command::RemoveTaskInventory { .. } => "remove_task_inventory",
        ...
        Command::IncrementCofVersion => "increment_cof_version",
        ...
        Command::QueryScriptPermissions => "query_script_permissions",
        ...
        Command::QueryParcelExperiences { .. } => "query_parcel_experiences",
        ...
        Command::InviteToChatSession { .. } => "invite_to_chat_session",
        ...
        Command::FetchSessionHistory { .. } => "fetch_session_history",
        Command::QueryChatSessions => "query_chat_sessions",
        Command::QueryChatHistoryPage { .. } => "query_chat_history_page",
        Command::QueryNearbyChatHistoryPage { .. } => "query_nearby_chat_history_page",
        Command::QueryInventoryFolder { .. } => "query_inventory_folder",
        Command::QueryInventoryRoots => "query_inventory_roots",
        Command::QueryInventoryFolders => "query_inventory_folders",
        ...
        Command::MarketplaceMerchantStatus => "marketplace_merchant_status",
        Command::MarketplaceListings => "marketplace_listings",
        Command::MarketplaceListing(..) => "marketplace_listing",
        Command::MarketplaceCreateListing(..) => "marketplace_create_listing",
        Command::MarketplaceUpdateListing(..) => "marketplace_update_listing",
        Command::MarketplaceAssociateListing(..) => "marketplace_associate_listing",
        Command::MarketplaceDeleteListing(..) => "marketplace_delete_listing",
