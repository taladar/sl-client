...
impl MediaData {
    ...
    #[must_use]
    pub fn entry(&self, target: MediaTarget) -> Option<&MediaEntry> {
        self.objects
            .get(&target.object)?
            .faces
...
#[must_use]
pub const fn media_permission_allows(perms: u8, is_owner: bool) -> bool {
